...
sr.reveal(`.home__data, .featured__container, .new__container, 
           .join__data, .testimonial__container, .footer, .questions, .section__title, .section__subtitle`)
...
document.querySelector('#contactAlert .closebtn').addEventListener('click', function () {
